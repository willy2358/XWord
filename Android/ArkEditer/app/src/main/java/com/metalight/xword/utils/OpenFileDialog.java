...
import com.metalight.xword.arkediter.*;
...
public class OpenFileDialog {  
	   ...
	   private static String fileExts = "doc;txt;";  
	     
	 
	   public static Dialog createDialog(int id, Context context, String title, CallbackBundle callback){ 
		   
		   Map<String, Integer> images = GetFileImages();
	       AlertDialog.Builder builder = new AlertDialog.Builder(context);  
	       builder.setView(new FileSelectView(context, id, callback, fileExts, images));  
	       Dialog dialog = builder.create();  
	       dialog.setTitle(title);  
	       return dialog;  
	   }  
	   
	   private static Map<String, Integer> GetFileImages()
	   {
		   Map<String, Integer> images = new HashMap<String, Integer>();  
           images.put(OpenFileDialog.sRoot, R.drawable.filedlg_root);   // ��Ŀ¼ͼ��  
           images.put(OpenFileDialog.sParent, R.drawable.filedlg_parent);    //������һ���ͼ��  
           images.put(OpenFileDialog.sFolder, R.drawable.filedlg_folder);   //�ļ���ͼ��  
           images.put("doc", R.drawable.filedlg_doc);    
           images.put(OpenFileDialog.sEmpty, R.drawable.filedlg_root);
           return images;
	   }
